...
- 🤖 **Telegram Бот:** Автоматична щоденна розсилка короткого астрологічного прогнозу користувачам у Telegram (з можливістю індивідуального налаштування часу отримання).
...
5. **Налаштування Telegram-розсилки (опціонально):**
   * Створіть бота через [@BotFather](https://t.me/BotFather) у Telegram та отримайте API Token.
   * Вставте токен у відповідне поле на сторінці налаштувань плагіна.
   * *Рекомендація для продакшену:* Вимкніть стандартний WP-Cron (`DISABLE_WP_CRON`) та налаштуйте системний Cron на сервері (`wget -q -O - https://your-site.com/wp-cron.php?doing_wp_cron`) для гарантованої своєчасної відправки повідомлень незалежно від відвідуваності сайту.
